...
use super::CompactionContinuity;
use super::EventMsg;
...
pub(super) struct CompactedItemWire<'a> {
    message: Cow<'a, str>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    continuity: Option<Cow<'a, CompactionContinuity>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl<'a> From<&'a CompactedItem> for CompactedItemWire<'a> {
    fn from(item: &'a CompactedItem) -> Self {
        ...
        Self {
            ...
            continuity: item.continuity.as_ref().map(Cow::Borrowed),
...
impl TryFrom<CompactedItemWire<'_>> for CompactedItem {
    ...
    fn try_from(item: CompactedItemWire<'_>) -> Result<Self, Self::Error> {
        ...
        Ok(Self {
            ...
            continuity: item.continuity.map(Cow::into_owned),
            replacement_history,
            window_number,

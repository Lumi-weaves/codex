...
- For coding tasks, prefer delegating concrete code-change worker subtasks over read-only analysis when the subagent can make a bounded patch in a clear write scope.
